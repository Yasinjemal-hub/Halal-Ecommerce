      ...
      >
        <div className="container navbar-inner">
          ...
          <Link to="/" className="navbar-logo" id="navbar-logo">
            <div className="logo-icon">
              ...
              >
                ...
                <path
                  d="M20 8L22.5 14H28L23.5 18L25.5 24L20 20.5L14.5 24L16.5 18L12 14H17.5L20 8Z"
                  fill="white"
                />
                <path
                  d="M20 26C20 26 14 30 14 32H26C26 30 20 26 20 26Z"
                  fill="white"
                  opacity="0.8"
                />
                <defs>
          ...
          <div className="navbar-actions">
            <button
              className="nav-action-btn mobile-search-btn"
            ...
            {isAuthenticated ? (
              <div className="user-menu-wrapper" ref={userMenuRef}>
                ...
                >
                  ...
                  <FiChevronDown
                    size={14}
                    className={`chevron ${isUserMenuOpen ? "chevron-open" : ""}`}
                  />
                </button>

                {isUserMenuOpen && (
                  <div
                    className="user-dropdown animate-scale-in"
                    id="user-dropdown"
                  >
